...
import scripts.api.util.Hovering;
...
//        final boolean shouldOpenMenu = Hovering.getShouldOpenMenu();
    ...
    public void performReactionTimeWait() {
        ...
        Global.script.setStatus("ABC2 - Reaction Wait: Waiting " + reactionTime + "ms.");
        General.println("Antiban: Sleeping for" + reactionTime + "ms");
...
//        log.info("Resource %s", won ? "Won" : "Lost");
    ...
    public static void doSimpleIdleActions() {
        if (get().shouldExamineEntity())
            get().examineEntity();
    ...
    public static void hoverNextResource(final Positionable currentlyInteracting) {
        ...
        if (currentlyInteracting instanceof RSObject) {
            ...
            final String objName = "";//TODO: ObjectsHelper.getName(interactingObject);
    ...
    public static void react() {
        ...
        if (General.random(0, 100) > reaction_chance)
           General.sleep(getShortReactionTime(), getLongReactionTime());
    }

    public static void reactNow() {
        //General.sleep(getShortReactionTime(), getLongReactionTime());
    }

    private static int reaction_chance = 0;

    public static void configure() {
        reaction_chance = General.random(10, 30);
    }

    public static int getShortReactionTime() {
        return 500;
    }

    public static int getLongReactionTime() {
        return 2000;
    }
